...
from tools.dataset.cov_ctr import TaskSubset
from tools.dataset.cov_ctr_tokenizer import TokenizerChen
...
class CvT2DistilGPT2IUXRayChen(CvT2DistilGPT2MIMICXRChen):
    def __init__(
        ...
        # Paths:
        self.labels_file_path =  '/kaggle/working/cvt2distilgpt2/dataset/covctr/annotation.json'
        self.dataset_dir = '/kaggle/input/cov-ctr-resized/images-224/'
